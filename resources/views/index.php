...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="<?= asset('shop/css/app.6b3c615f.css') ?>" rel="preload" as="style">
        <link href="<?= asset('shop/js/app.6e6a69c0.js') ?>" rel="preload" as="script">
        <link href="<?= asset('shop/js/chunk-vendors.fb4b1076.js') ?>" rel="preload" as="script">
        <link href="<?= asset('shop/css/app.6b3c615f.css') ?>" rel="stylesheet">
        <style>
            body {
    ...
    <body>
        ...
        <script src="<?= asset('shop/js/app.6e6a69c0.js') ?>">
        </script> 
    </body>
</html>